import{api as a}from"./axios.70926cff.js";import{u as f}from"./index.53176d0e.js";function q(){const t=f(),e=t.authToken,r=t.isUserLoggedIn;return e&&r?{headers:{authorization:e}}:{headers:{authorization:null}}}a.interceptors.request.use(function(t){return t.headers=q().headers,t},function(t){return Promise.reject(t)});a.getImageUrl=(t,e,r,i,n)=>{const s=n?"/public/":i?"/public/wmd/":r?"/public/wsm/":t.gt.sm?"/public/":"/public/wmd/";return a.defaults.baseURL+s+e};a.interceptors.response.use(function(t){return t},function(t){return Promise.reject(t)});var h={authLogin:function(t=[]){const{login_type:e,user:r,password:i}=t;return a.post("/graphql",{query:`query {
          authLogin (query: {
            ${e}: "${r}"
            password: "${i}"
          }) {
        ...
        authEditProfile (input: {
          ...
          }`})}},_={userUpdate:function(t=[]){const{username:e,name:r,bio:i,avatar_url:n,password:s,new_password:o,address:u,cityId:d,commissionExpire:p,commissionLimit:m,commissionPercentage:l}=t;return a.post("/graphql",{query:`mutation {
              userUpdate (input: {
                  ${e?`username: "${e}"`:""}
                  ${r?`name: "${r}"`:""}
                  ${i?`bio: "${i}"`:""}
        ...
        userActivateService (input: {
          ...
          userFindMyLikes (query: {
                ...
                }`})}},I={orderFind:function(t=[]){const{id:e}=t;return a.post("/graphql",{query:`query {
            orderFind (id: "${e}") {
              id
              paymentWallet
              transactionHash
        ...
        reportOrder(query: {
      ...
      }`})}},F={productFind:function(t=[]){const{id:e}=t;return a.post("/graphql",{query:`query {
                productFind (id: "${e}") {
                  pid
                  id
                  categoryId {
          ...
          productFindMyProducts (query: {
            ...
            }`})},productFindUserProducts:function(t=[]){const{limit:e="",offset:r="",sorting:i="",userId:n=""}=t;return a.post("/graphql",{query:`query {
          productFindUserProducts (query: {
            ...
            }`})},productCreate:function(t=[]){const{latlng:e,name:r,address:i,area:n,pricePerMeter:s,areaOfBuilding:o,rooms:u,details:d,ownerInfo:p,price:m,imageUrls:l,categoryId:c}=t;return a.post("/graphql",{query:`mutation {
          productCreate (input: {
            ${e?`latlng: "${e}"`:""}
            ${r?`name: "${r}"`:""}
            ${i?`address: "${i}"`:""}
        ...
        productDelete (input: {
              ...
              }`})},productUpdate:function(t=[]){const{id:e,pid:r,latlng:i,name:n,address:s,area:o,pricePerMeter:u,areaOfBuilding:d,rooms:p,details:m,ownerInfo:l,price:c,imageUrls:$,categoryId:g,isPublic:y=void 0}=t;return a.post("/graphql",{query:`mutation {
                productUpdate (input: {
                  ${e?`id: "${e}"`:""}
                  ${r?`pid: "${r}"`:""}
                  ${i?`latlng: "${i}"`:""}
              ...
              }`})}},A={mapFind:function(t=[]){const{type:e}=t;return a.post("/graphql",{query:`query {
            mapFind (query: {
              type: "${e}"
            }) {
              position
        ...
        slideDelete (input: {
          ...
          }`})}},U={auth:h,user:_,order:I,map:A,product:F,main:P};export{U as a};
